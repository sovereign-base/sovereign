...
- [ ] **Phase 14: Engine `anchor` command + init workflows** - Zero-dep `anchor add|list|check` over `.sovereign/external-docs/` + `init anchor-docs`/`init verify-self` orient blobs, fully `node --test`'d (ENG-09)
