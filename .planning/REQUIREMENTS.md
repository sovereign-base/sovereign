...
- [ ] **ENG-06**: The engine runs as zero-dependency Node (`.cjs`, no build step); `node --test` passes and an `npm pack` clean-install smoke test succeeds.
...
- [ ] **STATE-01**: A SOVEREIGN-enabled project contains a `.sovereign/` directory with MANIFEST.md, SOVEREIGN.md, CONTEXT.md, STATE.md, config.json, and the docs/ tree.
